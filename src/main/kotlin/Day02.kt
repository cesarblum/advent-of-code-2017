...
object Day02 {
    fun solvePart01(): Int = solve(::checksumPart01)

    fun solvePart02(): Int = solve(::checksumPart02)
    ...
    private fun solve(checksum: (List<List<Int>>) -> Int): Int = checksum(parseInput(input()))
    ...
    private fun input() = """157	564	120	495	194	520	510	618	244	443	471	473	612	149	506	138
