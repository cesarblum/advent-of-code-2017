...
object Day04 {
    fun solvePart1(): Int = solve(this::hasUniqueWords)

    fun solvePart2(): Int = solve(this::hasUniqueAnagrams)

    fun solve(predicate: (String) -> Boolean) = input().lines().count(predicate)
    ...
    private fun input() = """vxjtwn vjnxtw sxibvv mmws wjvtxn icawnd rprh
